...
| Mensurations | Un relevé se **corrige et se supprime depuis sa colonne** du tableau (15 septembre 2026) : le crayon rouvre le formulaire de saisie pré-rempli — le même formulaire, pas un second —, la corbeille demande confirmation. Une valeur mal lue sur le mètre se voit dans le tableau, et c'est là qu'on doit pouvoir la reprendre. Aucune règle en base à ajouter : la politique des mensurations est `FOR ALL` par centre depuis la 005. |
