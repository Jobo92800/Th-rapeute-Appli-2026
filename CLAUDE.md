...
`npm test` — **580 contrôles, à garder verts.** Ils couvrent ce qui décide
...
Migrations passées jusqu'à **058** incluse (la 054, la 057, la 059, la **060**, la **061**, la **062**, la **063** et la **064** sont écrites, à passer ; la 060 et la 062 demandent aussi de redéployer `synchro-airtable`), fonction Edge `gerer-les-comptes` déployée et vérifiée de bout en bout, `synchro-airtable` redéployée,
