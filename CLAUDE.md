...
| Le contrat d'une cure Alma | **Il dit le prix, pas le calendrier.** Deux contrats se signent ce jour-là et ne disent pas la même chose : celui du centre engage sur une prestation et sur un montant, celui d'Alma fixe les prélèvements — c'est lui qui fait foi, c'est lui qu'elle reçoit, et c'est Alma qui prélève. Recopier le calendrier dans les deux, c'était promettre deux fois la même chose dans des documents qui peuvent diverger : un report accordé par Alma, et le contrat du centre devient faux. Le bloc porte donc le montant total et « 10 fois par carte, via Alma ». **Les chèques gardent leur échéancier**, ligne à ligne : là, c'est le centre qui encaisse, et le document doit dire quoi, quand et comment. |
...
`npm test` — **536 contrôles, à garder verts.** Ils couvrent ce qui décide
