...
`npm test` — **629 contrôles, à garder verts.** Ils couvrent ce qui décide
...
accords de civilité, bilan santé, Bio-Portrait Anti-Âge (sur le barème livré par la 056), sommaire des podcasts (numérotation et avancement), compléments choisis avec la cure (montant et première échéance).
...
Migrations passées jusqu'à **058** incluse (la 054, la 057, la 059, la **060** à la **070** sont écrites, à passer ; la 060 et la 062 demandent aussi de redéployer `synchro-airtable`), fonction Edge `gerer-les-comptes` déployée et vérifiée de bout en bout, `synchro-airtable` redéployée,
