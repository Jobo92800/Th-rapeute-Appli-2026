...
`npm test` — **590 contrôles, à garder verts.** Ils couvrent ce qui décide
...
accords de civilité, bilan santé, Bio-Portrait Anti-Âge (sur le barème livré par la 056), sommaire des podcasts (numérotation et avancement).
